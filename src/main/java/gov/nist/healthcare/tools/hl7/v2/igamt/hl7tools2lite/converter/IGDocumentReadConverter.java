 ...
 */
@ReadingConverter
public class IGDocumentReadConverter implements Converter<DBObject, IGDocument2> {
	...
	@Override
	public IGDocument2 convert(DBObject source) {
		System.out.println("convert==>");
		IGDocument2 igd = new IGDocument2();
	...
	private Profile2 profile(DBObject source) {
	...
	private Segments segments(DBObject source, Profile2 profile) {
	...
	private Datatypes datatypes(DBObject source, Profile2 profile) {
	...
	private Messages messages(DBObject source, Profile2 profile) {
